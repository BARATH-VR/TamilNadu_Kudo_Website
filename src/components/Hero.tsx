...
export const Hero: React.FC<HeroProps> = ({ setCurrentView }) => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-zinc-950 via-zinc-900 to-red-950 text-white pt-12 pb-24 overflow-hidden border-b border-amber-900/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-amber-100 leading-tight tracking-tight">
              {language === 'en' ? (
                <>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <button
                ...
                className="w-full sm:w-auto gold-gradient-bg text-red-950 font-bold px-7 py-3.5 rounded-xl text-sm uppercase tracking-wider shadow-xl hover:brightness-110 transition-all flex items-center justify-center space-x-2"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-zinc-900/80 border border-amber-500/40 text-amber-200 hover:bg-amber-500/10 font-semibold px-6 py-3.5 rounded-xl text-sm transition-all flex items-center justify-center space-x-2"
              >
            ...
            <div className="pt-6 border-t border-amber-900/30 flex flex-wrap justify-center lg:justify-start gap-6 text-xs text-gray-300">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Glassmorphic Frame around martial arts action photo */}
              <div className="relative rounded-3xl p-3 bg-gradient-to-br from-amber-500/30 via-red-900/40 to-zinc-900 border border-amber-500/40 shadow-2xl overflow-hidden">
                <div className="relative rounded-2xl overflow-hidden aspect-4/3 sm:aspect-16/10">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-zinc-900/90 backdrop-blur-md rounded-xl p-3 border border-amber-500/30 flex items-center space-x-3">
              ...
              <div className="grid grid-cols-3 gap-2 mt-4">
                <div className="bg-zinc-900/90 rounded-xl p-3 border border-amber-500/20 text-center">
                  <span className="text-xl font-extrabold text-amber-400">14+</span>
                  <p className="text-[10px] text-gray-400 uppercase font-semibold">
                    {language === 'en' ? 'Districts' : 'மாவட்டங்கள்'}
                  </p>
                </div>
                <div className="bg-zinc-900/90 rounded-xl p-3 border border-amber-500/20 text-center">
                  <span className="text-xl font-extrabold text-amber-400">3,500+</span>
                  <p className="text-[10px] text-gray-400 uppercase font-semibold">
                    {language === 'en' ? 'Athletes' : 'வீரர்கள்'}
                  </p>
                </div>
                <div className="bg-zinc-900/90 rounded-xl p-3 border border-amber-500/20 text-center">
                  <span className="text-xl font-extrabold text-amber-400">24</span>
                  <p className="text-[10px] text-gray-400 uppercase font-semibold">
